...
PLATFORMS = ["sensor", "switch", "button", "select", "binary_sensor", "update", "number"]
...
ENTITY_ICONS = {
    ...
    "binary_sensor": {
        ...
        "GasSensorState": "mdi:gas-cylinder",
    ...
    # Number Icons
    "number": {
        "TempHighThreshold": "mdi:thermometer-high",
        "TempLowThreshold": "mdi:thermometer-low",
        "HumidityHighThreshold": "mdi:water-percent",
        "HumidityLowThreshold": "mdi:water-percent",
        "TempHighComfort": "mdi:thermometer",
        "TempLowComfort": "mdi:thermometer",
        "HumidityHighComfort": "mdi:water-percent",
        "HumidityLowComfort": "mdi:water-percent",
        # Lowercase variants for matching
        "temphighthreshold": "mdi:thermometer-high",
        "templowthreshold": "mdi:thermometer-low",
        "humidityhighthreshold": "mdi:water-percent",
        "humiditylowthreshold": "mdi:water-percent",
        "temphighcomfort": "mdi:thermometer",
        "templotcomfort": "mdi:thermometer",
        "humidityhighcomfort": "mdi:water-percent",
        "humiditylowcomfort": "mdi:water-percent",
    },
}
